...
def save_image(uploaded_file):
    if uploaded_file is not None:
        ...
        model = torch.load(Path(os.path.join("model", "model_training", "model.pt")))
        ...
        image = Image.open(Path('/Users/ajsharma/PycharmProjects/Xray_image_classification/images/input.jpeg'))
